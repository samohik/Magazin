...
class Cart(object):
    ...
    def add(self, product: {id}, quantity: int = 1, update_quantity=False):
        """
        Добавление товара в корзину или обновление его количества.
        :param product: product id
        :param quantity: number of products
        :param update_quantity: a boolean indicating whether the product quantity value should be replaced with a new one (True) or should be added
        it to the existing one (False).
        :return: None
        """
    ...
    def remove(self, product: {id}) -> None:
        """
